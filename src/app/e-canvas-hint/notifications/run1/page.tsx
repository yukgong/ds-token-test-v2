...
// 가장 연한 중립 배경 = neutral.canvas.02 (레이아웃 패널)
...
// 선택된 필터: primary fill + inverse text (컴포넌트 표면)
...
// 오른쪽 알림 목록 영역: 레이아웃 배경 → canvas.02
...
// 읽지 않음 카드: 메인 컬러 계열 가장 연한 배경 → primary.surface.base (컴포넌트 카드 표면)
...
// 읽음 카드: 기본 밝은 배경 → neutral.canvas.03 (카드/컨테이너 레이어)
...
// 왼쪽 강조선 (읽지 않음 — 해당 역할 색상의 가장 강한 채움)
...
// 읽음 상태 ghost — disabled (opacity: 0.38)
...
// 빈 상태 카드: 레이아웃/구조 컨테이너 → canvas.03 (canvas.02 위에 얹히는 면)
    ...
    <div className={pageWrapperStyle}>
      ...
      <header className={headerStyle}>
        ...
        <div className={tabBarStyle}>
          {/* 활성 탭: primary 계열 강조선 + primary 텍스트 */}
