...
function FreePlanCard() {
  ...
  return (
    ...
    >
      <span className={css({ fontSize: '20px', fontWeight: '700', color: 'neutral.text.base' })}>
        Free
      </span>
      <span className={css({ fontSize: '28px', fontWeight: '700', color: 'neutral.text.base' })}>
        ₩0/월
      </span>
      <ul
        className={css({
      ...
      >
        {included.map((feat) => (
          <li key={feat} className={css({ display: 'flex', alignItems: 'center', gap: '8px' })}>
            <Check size={16} className={css({ color: 'positive.icon.base', flexShrink: 0 })} />
            <span className={css({ fontSize: '14px', color: 'neutral.text.base' })}>{feat}</span>
          </li>
        ))}
        {excluded.map((feat) => (
          <li
    ...
    >
      ...
      >
        <div className={css({ display: 'flex', alignItems: 'center', gap: '8px' })}>
          <span className={css({ fontSize: '20px', fontWeight: '700', color: 'primary.text.base' })}>
            Pro
          </span>
          <span
            className={css({
        ...
        <span className={css({ fontSize: '28px', fontWeight: '700', color: 'primary.text.base' })}>
          ₩49,000/월
        </span>
        <ul
          className={css({
      ...
      >
        ...
        >
          ...
          >
            ...
            <div className={css({ display: 'flex', alignItems: 'center', gap: '8px' })}>
              <span className={css({ fontSize: '14px', color: 'neutral.text.low' })}>만료일 12/26</span>
              <span
                className={css({
                  fontSize: '11px',
                  fontWeight: '600',
...
const billingRows: {
  ...
  { date: '2025-08-01', desc: 'Pro 플랜 (8월)', amount: '₩49,000', status: '결제 완료', statusVariant: 'positive', action: 'receipt' },
  { date: '2025-07-01', desc: 'Pro 플랜 (7월)', amount: '₩49,000', status: '결제 완료', statusVariant: 'positive', action: 'receipt' },
  { date: '2025-06-15', desc: '추가 사용자 시트', amount: '₩9,000', status: '결제 완료', statusVariant: 'positive', action: 'receipt' },
  { date: '2025-06-01', desc: 'Pro 플랜 (6월)', amount: '₩49,000', status: '결제 실패', statusVariant: 'critical', action: 'retry' },
  { date: '2025-05-28', desc: 'Pro 플랜 (6월) 재시도', amount: '₩49,000', status: '결제 완료', statusVariant: 'positive', action: 'receipt' },
  { date: '2025-05-01', desc: 'Pro 플랜 (5월)', amount: '₩49,000', status: '결제 완료', statusVariant: 'positive', action: 'receipt' },
  { date: '2025-04-01', desc: 'Pro 플랜 (4월)', amount: '₩49,000', status: '처리 중', statusVariant: 'warning', action: 'none' },
  { date: '2025-03-10', desc: '환불 처리', amount: '-₩49,000', status: '환불 완료', statusVariant: 'info', action: 'detail' },
  { date: '2025-03-01', desc: 'Pro 플랜 (3월)', amount: '₩49,000', status: '결제 완료', statusVariant: 'positive', action: 'receipt' },
];
              ...
              >
                ...
                <td className={css({ padding: '12px 16px' })}>
                  {row.action === 'receipt' || row.action === 'detail' ? (
                    ...
                    >
                      <RefreshCw size={13} className={css({ color: 'critical.icon.base' })} />
                      재시도
                    </button>
                  ) : (
                    <span className={css({ fontSize: '13px', color: 'neutral.text.lowest' })}>—</span>
                  )}
                </td>
              </tr>
            ))}
    ...
    <section>
      ...
      >
        ...
        >
          ...
          <span className={css({ fontSize: '26px', fontWeight: '700', color: 'neutral.text.base' })}>
            ₩58,000
          </span>
          <span
            className={css({
        ...
        >
          ...
          <span className={css({ fontSize: '14px', fontWeight: '600', color: 'critical.text.base' })}>
            미결제 금액
          </span>
          <button
            className={css({
        ...
        >
          ...
          <span className={css({ fontSize: '22px', fontWeight: '700', color: 'neutral.text.base' })}>
            2025년 9월 1일
          </span>
          <span
            className={css({
