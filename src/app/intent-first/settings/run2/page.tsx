    ...
    >
      ...
      >
        ...
        <nav className={css({ display: 'flex', flexDirection: 'column', gap: '2px' })}>
          ...
          >
            <User size={16} className={css({ color: 'primary.icon.base', flexShrink: 0 })} />
            프로필
          </a>
          ...
          >
            <CreditCard size={16} className={css({ color: 'neutral.icon.base', flexShrink: 0 })} />
            구독 플랜
          </a>
          ...
          >
            <ShieldCheck size={16} className={css({ color: 'neutral.icon.base', flexShrink: 0 })} />
            보안
          </a>
          ...
          >
            <Bell size={16} className={css({ color: 'neutral.icon.base', flexShrink: 0 })} />
            알림
          </a>
          ...
          >
            <AlertTriangle size={16} className={css({ color: 'critical.icon.base', flexShrink: 0 })} />
            위험 구역
          </a>
        </nav>
      </aside>
        ...
        <div className={css({ display: 'flex', flexDirection: 'column', gap: '24px' })}>
            ...
            <div className={css({ padding: '24px' })}>
              ...
              >
                ...
                <div className={css({ display: 'flex', flexDirection: 'column', gap: '6px' })}>
                  <label className={css({ fontSize: '14px', fontWeight: '500', color: 'neutral.text.base' })}>
                    이름
                  </label>
                  <input
                    type="text"
          ...
          >
            ...
            >
              ...
              <p className={css({ fontSize: '14px', color: 'info.text.base' })}>
            ...
            <div className={css({ display: 'flex', flexDirection: 'column', gap: '16px', marginBottom: '24px' })}>
              ...
              <div className={css({ display: 'flex', flexDirection: 'column', gap: '6px' })}>
                ...
                <div className={css({ display: 'flex', alignItems: 'center', gap: '6px' })}>
                  ...
                  <span className={css({ fontSize: '13px', color: 'critical.text.base' })}>
                    비밀번호가 일치하지 않습니다.
                  </span>
                </div>
              </div>
              ...
              <div className={css({ display: 'flex', flexDirection: 'column', gap: '6px' })}>
                ...
                <div className={css({ display: 'flex', alignItems: 'center', gap: '6px' })}>
                  ...
                  <span className={css({ fontSize: '13px', color: 'positive.text.base' })}>
                    사용 가능한 이메일입니다.
                  </span>
                </div>
              </div>
          ...
          >
            ...
            >
              <div className={css({ display: 'flex', gap: '12px' })}>
                <ShieldCheck
                  size={20}
                  className={css({ color: 'positive.icon.base', flexShrink: 0, marginTop: '2px' })}
                />
                <div>
                  <p className={css({ fontSize: '15px', fontWeight: '600', color: 'neutral.text.base' })}>
                    2단계 인증
                  </p>
          ...
          >
            ...
            >
              ...
              <p className={css({ fontSize: '14px', color: 'warning.text.base' })}>
            ...
            <div className={css({ display: 'flex', flexDirection: 'column', gap: '16px', marginBottom: '24px' })}>
              ...
              >
                ...
                >
                  <span className={css({ color: 'inverse.text.base', fontSize: '11px', fontWeight: '700', lineHeight: 1 })}>
                    ✓
                  </span>
                </div>
                <div>
              ...
              <div className={css({ display: 'flex', alignItems: 'flex-start', gap: '12px' })}>
                ...
                <div>
                  <p className={css({ fontSize: '14px', fontWeight: '500', color: 'neutral.text.base' })}>결제 알림</p>
                  <p className={css({ fontSize: '13px', color: 'neutral.text.low' })}>영수증 및 결제 관련 안내</p>
                </div>
              </div>
              ...
              <div className={css({ display: 'flex', alignItems: 'flex-start', gap: '12px' })}>
                ...
                <div>
                  <p className={css({ fontSize: '14px', fontWeight: '500', color: 'neutral.text.base' })}>배포 알림</p>
                  <p className={css({ fontSize: '13px', color: 'neutral.text.low' })}>배포 완료 및 실패 알림</p>
                </div>
              </div>
              ...
              <div className={css({ display: 'flex', alignItems: 'flex-start', gap: '12px' })}>
                ...
                <div>
                  <p className={css({ fontSize: '14px', fontWeight: '500', color: 'neutral.text.base' })}>보안 알림</p>
                  <p className={css({ fontSize: '13px', color: 'neutral.text.low' })}>로그인 및 보안 이벤트</p>
                </div>
              </div>
              ...
              <div className={css({ display: 'flex', alignItems: 'flex-start', gap: '12px' })}>
                ...
                />
                <div>
                  <p className={css({ fontSize: '14px', fontWeight: '500', color: 'neutral.text.base' })}>마케팅 알림</p>
                  <p className={css({ fontSize: '13px', color: 'neutral.text.low' })}>제품 업데이트 및 프로모션</p>
                </div>
              </div>
              ...
              <div className={css({ display: 'flex', alignItems: 'flex-start', gap: '12px' })}>
                ...
                />
                <div>
                  <p className={css({ fontSize: '14px', fontWeight: '500', color: 'neutral.text.base' })}>뉴스레터</p>
                  <p className={css({ fontSize: '13px', color: 'neutral.text.low' })}>월간 뉴스레터</p>
                </div>
              </div>
            </div>
